...
class DatabaseSeeder extends Seeder
{
    ...
    public function run(): void
    {
        ...
        $androids = [
            ...
            ['name' => 'YoRHa No.1 Type E', 'model_id' => '1', 'type_id' => '6', 'type_number' => '1', 'appearance_id' => '2', 'state_id' => '2', 'description' => 'Also know as just Commander, determines all large-scale strategies as well as directs, deploys, and oversees all units from her station at the Bunker outpost in Earths orbit.']
        ];
